Pod::Spec.new do |s|
  ...
  s.source           = { :http => 'https://github.com/oliver-was-here/SpecRepo/releases/download/1.0.24/TradeItAccountOpeningSDK.zip' }
  s.social_media_url = 'https://twitter.com/tradeit'

  s.ios.deployment_target = '11.0'

  s.frameworks = 'UIKit'
  s.ios.vendored_frameworks = 'build/zip/iOS/TradeItAccountOpeningSDK.framework'
